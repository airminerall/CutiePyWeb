...
function openGroupProfile(member) {
    if (member === 'christian') navigateTo('group-profile');
    if (member === 'stanly') navigateTo('group-profile-stanly');
    if (member === 'nathanael') navigateTo('group-profile-nathanael');
    if (member === 'jennifer') navigateTo('group-profile-jennifer');
    if (member === 'jasselynn') navigateTo('group-profile-jasselynn');
}
